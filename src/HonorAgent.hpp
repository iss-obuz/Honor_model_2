...
/// (Version for publication accepted 07.2015, comments changed 2022.07)
//*//////////////////////////////////////////////////////////////////////////////
...
extern FLOAT    CALLER_POPU; ///< Default:=0.25; Ratio of police callers (Jaka część wzywa policje zamiast walczyć)
...
class HonorAgent
{
 ...
 public: 
    ...
    //*//////////////////////////////////////////
    friend void InitAtributes(FLOAT HowMany);       //!< first part of initialisation
	friend void InitConnections(FLOAT HowManyFar);  //!< second part of initialisation
 ...
 private:
    ...
    Decision  MemOfLastDecision; //!< Memeory of last decision
